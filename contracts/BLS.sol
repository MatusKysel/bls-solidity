...
contract BLS {
    ...
    function getG2Generator() internal pure returns (G2Point memory) {
        return
            G2Point(
                [BN256G2.G2_NEG_X_RE, BN256G2.G2_NEG_X_IM],
                [BN256G2.G2_NEG_Y_RE, BN256G2.G2_NEG_Y_IM]
            );
    }
    ...
    function verifyPairing(G1Point memory point1, G2Point memory point2)
        internal
        returns (bool)
    {
    ...
    function verifySignature(
        ...
        return
            verifyPairing(hashToG1(_message), publicKey) &&
            verifyPairing(signature, getG2Generator());
    }
}
